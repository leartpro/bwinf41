...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \end{subfigure}
        \caption{alleskaese1.txt}\label{fig:figAB1}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \end{subfigure}
        \caption{small square}\label{fig:figAB2}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \end{subfigure}
        \caption{unsolved square}\label{fig:figAB3}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \end{subfigure}
        \caption{three square}\label{fig:figAB4}
    \end{figure}
