...
\begin{document}
    ...
    \begin{algorithm}[H]
        ...
        \label{alg:p}
        \Require{Das maximale Gesamtvolumen $volume$ für jede Kombination, die Anzahl der Quader in jeder Kombination $count\_of\_squares$, die gegebene Menge an Scheiben $slices$}
        \Ensure{Alle Kombinationen für die gegebenen Parameter}
        \Function{find\_all\_dimensions}{$volume, slices, count\_of\_squares$}
            ...
            \For{Jede Scheibe $slice$ in $slices$}
            ...
            \For{$combination$ in $combinations$}
                \If{Die Größe von $combination$ ist nicht gleich $count_{of}_{squares}$}
