...
\begin{document}
    ...
    Aber Aufgrund der Tatsache, dass es für $n$ Elemente $n!$ viele Permutationen gibt,
    ...
    \begin{algorithm}
        ...
        \begin{algorithmic}
            \Function{CrossAngle}{$von_{knoten},\ddot uber_{knoten},zu_{knoten}$}
    ...
    \begin{lstlisting}[frame=single,language=C++,title=Methode graphFromLines,breaklines=true,label={lst:lstlisting2}]
    /**
...
int main() {
    ...
    \newpage
    \begin{lstlisting}[frame=single,language=C++,title=Methode graphFromLines,breaklines=true,label={lst:lstlisting}]
    /**
...
return false;
    ...
    \newpage
    \begin{lstlisting}[frame=single,language=C++,title=Methode graphFromLines,breaklines=true,label={lst:lstlisting3}]
    /**
